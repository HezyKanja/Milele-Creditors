...
<div class="subnav">
    ...
    <a href="user_approved_loans.php" class="active">Approved Loans</a>
...
<?php if (count($loans) === 0): ?>
    <p style="text-align:center;">No approved loans found.</p>
<?php else: ?>
    ...
    <?php endif; ?>
            ...
            <div style="text-align: center; margin-top: 20px; padding: 12px 20px; font-size: 16px; background-color: #28a745; color: white; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); display: inline-block;">
    <a href="download_approved_loans_pdf.php?loan_id=<?= $loan['id'] ?>" class="btn" style="color: white; text-decoration: none; font-weight: bold;">
